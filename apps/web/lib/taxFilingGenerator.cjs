/**
 * CommonJS shim for taxFilingGenerator.ts
 * Allows tests to import TypeScript code directly
 */

/**
 * Validate filing data before generation
 */
function validateFilingData(data) {
  const errors = [];
 ...
 */
function generateIRSForm941(data) {
 ...
 */
function generateHMRCP30B(data) {
 ...
 */
async function generateTaxFiling(data) {
  try {
